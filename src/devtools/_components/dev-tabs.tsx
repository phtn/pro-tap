...
import {deleteInactiveCards} from '@/lib/firebase/cards'
/**
...
export function DevTabs({
  ...
  const handleDeleteCards = async () => {
    await deleteInactiveCards('general')
  }
            ...
            <div className='relative h-full'>
              ...
              <div className='p-6 h-full relative flex flex-col'>
                <div className='space-y-2'>
                  <h3 className='text-2xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]'>
                    Icons
                  </h3>
