  ...
  return (
    <div className='flex flex-col gap-4'>
      <Sheet open={open} onOpenChange={onOpenChange}>
        ...
        <SheetContent
          side='bottom'
          className='space-y-3 md:space-y-0 h-[90vh] md:h-[60vh] dark:bg-zinc-800 rounded-t-3xl overflow-hidden p-4 md:p-6'>
          <div className='flex flex-col w-full md:flex-row md:gap-6 gap-2 h-full'>
            ...
            <div className='flex items-center justify-center md:items-start md:justify-start p-4 md:p-2'>
              <div className='bg-white flex items-center md:items-start justify-center p-3 md:p-2 w-full h-full md:h-fit rounded-3xl'>
                <QRCodeSVG
            ...
            <div className='flex-1 space-y-1 md:space-y-6 md:max-w-md md:p-2 overflow-y-scroll'>
              <div className='space-y-1 md:space-y-4'>
                <div className='space-y-1 md:space-y-4 pb-12'>
                  ...
                  <div className='bg-zinc-50 dark:bg-zinc-700 md:w-fit p-2 rounded-lg'>
                    <div className='text-xs md:text-sm text-muted-foreground uppercase tracking-wide font-medium mb-1'>
                      Activation URL
                    </div>
                    <div className='font-mono w-full md:w-fit whitespace-nowrap overflow-x-scroll text-xs text-slate-400 break-all'>
