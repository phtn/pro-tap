  ...
  return (
    <div className='h-full w-full flex flex-col items-start font-figtree space-y-1'>
      ...
      <Input
        ...
        className='text-xs md:text-sm border-transparent uppercase dark:border-transparent font-space dark:bg-origin md:w-fit w-14 pl-2 pr-2 md:pl-3 md:h-10 h-7 bg-muted'
      />
    </div>
  )
}
