      ...
      <div className="aspect-square m-w-sm md:max-w-xl mx-auto relative">
        ...
        <div className="relative h-full w-full rotate-90 flex items-center justify-center">
          <Hex
            size={320}
            className={cn(
              "scale-75 md:scale-100 absolute blur-sm -bottom-4 dark:skew-x-[45deg] -skew-x-[50deg] right-2 dark:fill-sky-100/70 fill-foreground",
          ...
          <Hex
            size={240}
            className={cn(
              "scale-75 md:scale-100 fill-primary-hover rounded-full blur-2xl skew-x-6",
            )}
          />
        </div>
      </div>
