...
const NtagCode = ({serialNumber}: NtagCodeProps) => {
  return (
    <div className='md:w-80 w-48 flex items-center justify-end overflow-hidden'>
      <AnimatePresence mode='wait'>
        <motion.span
          ...
          className='capitalize font-doto text-xs lg:text-2xl font-bold tracking-wide md:tracking-widest whitespace-nowrap text-foreground opacity-80'>
