...
import { SignInCardProps } from './authed-card'

export const SignInBeams = ({ user, signOut }: SignInCardProps) => {
  return (
  ...
  return (
    <div className='flex flex-col justify-center space-y-12 font-figtree'>
      ...
      >
        ...
        <span className='pl-3 font-semibold dark:text-zinc-600 text-lg'>
          Google
        </span>
      </TextureButton>
      <TextureButton
      ...
      >
        ...
        <svg
          ...
          xmlns='http://www.w3.org/2000/svg'
          preserveAspectRatio='xMidYMid'
          className='size-6 text-zinc-700 dark:text-foreground'
        >
          <path
