                    ...
                    <div className="py-2 px-5 w-full">
                      <div className="w-full flex items-center justify-between text-xs tracking-wide font-light font-mono text-teal-400">
                        <div className="flex items-center space-x-1">
                          <Icon
                            name="reactjs"
                            className="size-4 text-[#58c4dc]"
                          />
                          <Icon
                            name="typescript"
                            className="size-4 text-[#3078c6]"
                          />
                        ...
                        <div className="flex items-center space-x-1">
                          <Icon
                            name="link"
                            className="size-3.5 opacity-80 text-teal-400"
                          />
                          <span className="bg-background/40 px-2 py-1 rounded-lg">
