...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(266,100%,90%,var(--card-opacity)) 4%,hsla(166,50%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(166,25%,70%,calc(var(--card-opacity)*0.5)) 50%,hsla(166,0%,60%,0) 100%),radial-gradient(35% 52% at 55% 20%,#00ffaac4 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#00c1ffff 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#c137ffff 0%,#07c6ffff 40%,#07c6ffff 60%,#0130ffff 100%)'
...
export const HyperId = ({
  ...
  return (
    <div
      ...
      <section
        ref={cardRef}
        className='overflow-hidden relative pc-card scale-100'>
        <div className='pc-inside overflow-hidden '>
          <div className='pc-shine overflow-hidden ' />
          {/*<div className='pc-glare overflow-hidden ' />*/}
          {children}
        </div>
      </section>
    </div>
